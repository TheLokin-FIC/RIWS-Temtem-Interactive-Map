...
import { ButtonUnstyled, Slide } from "@mui/material";
...
export default function Drawer() {
  ...
  return (
    <Box className={"drawer " + (!open ? "close" : "")}>
      <ButtonUnstyled className="drawer-button" onClick={() => setOpen(!open)}>
        {open ? (
      ...
      <Box className="all" style={{ maxHeight: "100%", overflow: "auto" }}>
        <Box className="image">
